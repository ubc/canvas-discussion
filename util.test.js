...
describe('Utils Functions', () => {
  ...
  describe('roundedAverage', () => {
    ...
    test('should calculate and round the average of mixed numbers', () => {
      ...
      expect(roundedAverage([1, -1, 2, -2], 1)).toBe(0) // Average is 0.0
      expect(roundedAverage([1, -1, 2, -2], 2)).toBe(0) // Average is 0.00
    })
  
    test('should handle empty array', () => {
      expect(roundedAverage([], 2)).toBe(0) // Average of an empty array is 0 rounded to 2
    })
